...
def american_movie_names_func():
	
	for i in range(1900,2032):
	    ...
	    # print(f"Failed to fetch page for year {i}, status code: {response.status_code}")
		...
		# try:
			...
			with open("american_movie_names.txt",'a') as file:
